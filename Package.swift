...
let package = Package(
    ...
    products: [
      ...
      targets: [
        ...
        .binaryTarget(
            name: "RadarSDK",
            url: "https://github.com/radarlabs/radar-sdk-ios/releases/download/3.24.0-beta.1/RadarSDK.xcframework.zip",
            checksum: "cd1c8cb527b1582929171843b48c4484457d97c17e6f826ab556dcc7a81143ac" // RadarSDK checksum
        ),
        .binaryTarget(
            name: "RadarSDKMotion",
            url: "https://github.com/radarlabs/radar-sdk-ios/releases/download/3.24.0-beta.1/RadarSDKMotion.xcframework.zip",
            checksum: "6a78704ce2b158ad5f08cac5ce5980ea72ba4533ee83c176e089b10ad1821962" // RadarSDKMotion checksum
        ),
        .binaryTarget(
            name: "RadarSDKIndoors",
            url: "https://github.com/radarlabs/radar-sdk-ios/releases/download/3.24.0-beta.1/RadarSDKIndoors.xcframework.zip",
