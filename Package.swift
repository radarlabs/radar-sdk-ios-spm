...
let package = Package(
    ...
    products: [
      ...
      targets: [
        ...
        .binaryTarget(
            name: "RadarSDK",
            url: "https://github.com/radarlabs/radar-sdk-ios/releases/download/3.26.2-beta.2/RadarSDK.xcframework.zip",
            checksum: "2ffe0c320fdbeaa62095c18dfaed930c3ea7cc148703ecd20457ce557bf3112f" // RadarSDK checksum
        ),
        .binaryTarget(
            name: "RadarSDKMotion",
